...
**Linux — taip pat reikalinga vykdymo metu, video preview funkcijai:** be šių paketų
WebKitGTK video grotuvas gali crash'inti vietoj švelnios klaidos.
...
- [OpenEmu](https://openemu.org) — įkvėpimas, kaip emuliavimo UI _gali_ atrodyti
